...
const mapStateToProps = ({listData}) => ({
    pending:listData.getIn([actionType.AWARD_ACCEPT_LIST,'pending']),
    list:listData.getIn([actionType.AWARD_ACCEPT_LIST,'data']),
    pageEnd:listData.getIn([actionType.AWARD_ACCEPT_LIST,'pageEnd'])
});
const mapDispatchToProps = (dispatch) => ({
    ...
    getList(){
        dispatch({
            type:actionType.AWARD_ACCEPT_LIST,
            params:[{status:'done'}]
        });
    },
    clear(){
        dispatch({
            ...
            key:actionType.AWARD_ACCEPT_LIST
        });
    }
});
